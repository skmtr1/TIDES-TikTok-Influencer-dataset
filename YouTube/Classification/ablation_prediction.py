...
for c in df_infl.columns:
    if c in col_to_drop:
        continue 
    if c == "tot_videos" or c == "videos_per_day":
        general_features.append(c)
    if "audio_" in c or "spotify" in c:
...
column_names_combinations = ["('general',)", "('video',)", "('audio',)", "('text',)", "('video', 'general', 'audio', 'text')"]
            ...
            for k_best in k_bests:
                ...
                for train_index,test_index in sss.split(X, y):
                    ...
                    try:
                        ...
                        df_feature_imp.to_csv("ALL_ablation_feature_importance.csv", index=False)
                    ...
                    df_results.to_csv("ALL_ablation_results.csv", index = False)
