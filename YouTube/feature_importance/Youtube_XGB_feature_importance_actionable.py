...
def select_best_model(df_ab, tier, feature, iter):
    ...
    clf = XGBClassifier(random_state=123, n_jobs=16) # tree_method="gpu_hist", gpu_id = 0)
            ...
            for k_best in k_bests:
                ...
                for train_index,test_index in sss.split(X, y):
                    ...
                    try:
                        ...
                        df_feature_imp.to_csv(f"Youtube_XGB_actionable_{file_save_name[i]}_feature_importance.csv", index=False)
                    ...
                    df_results.to_csv("Youtube_XGB_actionable_fi_results_cross_val.csv", index = False)
