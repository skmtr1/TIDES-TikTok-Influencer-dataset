...
videos = [line.rstrip() for line in open("f1.txt")]
...
for v in videos:
    ...
    try:
        ...
        elem = WebDriverWait(driver, 10).until(
            EC.visibility_of_element_located((By.CLASS_NAME,"tik-button-dl"))
        )


        # elem = driver.find_element(By.CLASS_NAME, 'tik-button-dl') #button for download
        time.sleep(1)
        elem.click()
        print("sleeping...")
