        ...
        for i, col_ablation in enumerate(column_combinations):
            ...
            for k_best in k_bests:
                ...
                for train_index,test_index in sss.split(X, y):
                    ...
                    # define search
                    search = GridSearchCV(pipe, param_grid, scoring='f1_macro', cv=cv_inner, refit=True, n_jobs = 16)
                    ...
                    try:
                        ...
                        df_feature_imp.to_csv("ablation_feature_importance.csv", index=False)
                    ...
                    df_results.to_csv("ablation_results_cross_val.csv", index = False)
